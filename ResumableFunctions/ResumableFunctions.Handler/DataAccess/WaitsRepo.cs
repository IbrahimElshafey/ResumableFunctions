...
internal partial class WaitsRepo : IWaitsRepo
{
    ...
    public async Task<ImpactedWorkflowsIds> GetCallEffectionInCurrentService(string methodUrn, DateTime puhsedCallDate)
    {
    ...
    public async Task<List<ImpactedWorkflowsIds>> GetImpactedWorkflows(string methodUrn, DateTime puhsedCallDate)
    {
        var methodGroup = await GetMethodGroup(methodUrn);
        ...
        return (
              ...
              select new ImpactedWorkflowsIds
              {
