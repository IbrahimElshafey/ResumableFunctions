...
public interface IWaitsRepo
{
    ...
    Task<List<ImpactedWorkflowsIds>> GetImpactedWorkflows(string methodUrn, DateTime puhsedCallDate);
    Task<ImpactedWorkflowsIds> GetCallEffectionInCurrentService(string methodUrn, DateTime puhsedCallDate);
